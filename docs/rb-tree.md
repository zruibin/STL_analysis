...
有关红黑树的知识在前面博文有介绍，读者可自行往前面博文[《红黑树RB-Tree》](http://blog.csdn.net/chenhanzhun/article/details/38405041)，[《二叉查找树》](http://blog.csdn.net/chenhanzhun/article/details/21990545)阅读。本文介绍的RB-Tree(红黑树)是来自源码SGI STL中的文件`<stl_tree.h>`。这里采用了header技巧，header指向根节点的指针，与根节点互为对方的父节点。他们之间的结构如下图所示：
...
* 《STL源码剖析》侯捷
* [《STL源码剖析---stl_tree.h阅读笔记》](http://blog.csdn.net/kangroger/article/details/38587785)