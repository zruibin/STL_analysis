...
注：本文所列的源码出自SGI STL中的文件<stl_list.h>，对于list容器类的详细信息也可以查看[《list容器库》](http://zh.cppreference.com/w/cpp/container/list)和[《MSDN的list类》](http://msdn.microsoft.com/zh-cn/library/802d66bt.aspx)
...
下图是执行第一过程`Remove[first, last) from its old position`流图：

![](./images/list04.png)

下图是执行第二过程`Splice [first, last) into its new position`流图：
...
* 《STL源码剖析》侯捷
* [《STL笔记之list》](http://www.programlife.net/stl-list.html)
* [《STL源码剖析--stl_list.h》](http://blog.csdn.net/mdl13412/article/details/6645244)
* [《STL源码剖析 容器 stl_list.h》](http://blog.csdn.net/zhengsenlie/article/details/38011161)
